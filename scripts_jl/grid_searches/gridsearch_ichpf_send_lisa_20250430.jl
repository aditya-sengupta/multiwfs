...
for r0_ncp in r0_ncp_vals
    ...
    for f_crossover in f_crossover_vals
        ...
        grid_search_coarse_to_fine((gf, gs, fc) -> simgen_ichpf(gf, gs, fc, vk_ncp, f_crossover), [[0.0, 1.0], [0.0, 10.0], [0.0, 200.0]], search="parallel", niter=7, npoints_per_parameter=21)[1],
...
save("ic_opt_lisa_20250430.jld2", all_opt)
...
save("ic_singlewfs_opt_lisa_20250430.jld2", all_opt)